		...
		<aside class="main-sidebar">
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						<a href="#"><i class="fa fa-pie-chart"></i><span>Tags</span><i class="fa fa-angle-left pull-right"></i></a>
						<ul style="display: none;" class="treeview-menu">
							<li><a href="{{route('backend.tags.index')}}"><i class="fa fa-circle-o"></i> Index</a></li>
							<li><a href="{{route('backend.tags.create')}}"><i class="fa fa-circle-o"></i> Create Tag</a></li>
						</ul>
					</li>
					</li>
				</ul>
